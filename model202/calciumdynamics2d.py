...
def c_update(c,a,par):
    ...
    h1 = step_f(a,s0)
    h2 = step_f(c,0.01)*step_f(a,4*s0)+step_f(c,c0*3)-step_f(c,c0*3)*step_f(c,0.01)*step_f(a,4*s0)
...
def gamma_update1(c,hs, par, gamma_vec):
    ...
    h1 = step_f1(c,c0) #Calcium concentration promotes myosin production
    h2 = step_f1(s1,hs) # Stretch inhibits myosin production
